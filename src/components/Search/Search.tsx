    ...
    return (
        <div className="relative min-h-screen bg-white dark:bg-[#121212] text-zinc-900 dark:text-white p-4 md:p-8 pb-32">
            ...
            >
                <div className="flex items-center gap-3">
                    <BackButton className="bg-black/5 hover:bg-black/10 dark:bg-white/10 dark:hover:bg-white/20
                        p-2 rounded-full text-black dark:text-white transition-all shrink-0" />
            ...
            {query ? (
                ...
                >
                    <h2 className="text-xl font-bold mb-5">{t('search.browse_all')}</h2>
                        ...
                        {categories.map((cat, index) => {
                            ...
                            return (
                                <CategoryCard
                                    ...
                                    onClick={() => navigate(`/category/${cat.id}`, { state: { colorHex: palette.hex } })}
                                />
                            );
                        })}
                    </div>
